    ...
    class WP_Admin_Bar
        {
            ...
            public function add_menu( $node ) 
                {
                    ...
                    //update the href attribute for specific nodes
                    switch($node['id'])
                        {
                                                    
                            case   'my-sites' :
                            case    (preg_match('/network-admin(-.*)?/', $node['id']) ? true : false)  :
                                                                                        
                                                                                        if(is_multisite() )
                                                                                            {
                                                                                                $ms_settings    =   $wph->functions->get_site_settings('network');
                                                                                                $admin_slug =   $wph->functions->get_site_module_saved_value('admin_url',  'network' );
                                                                                                    
                                                                                            }
                                                                                            else
                                                                                            $admin_slug =   $wph->functions->get_site_module_saved_value('admin_url',  1 );
                                                                                        ...
                                                                                        $replace        =   $blog_details->domain    .  $blog_details->path .   'wp-admin';
                                                                                        $replacement    =   $blog_details->domain    .  $blog_details->path .   $admin_slug;
                                                                                        
                                                                                        $node['href']   =   str_replace($replace, $replacement,  $node['href']);
                            ...
                            case    'logout'  :
                                                                            if(is_multisite() )
                                                                                            {
                                                                                                $ms_settings    =   $wph->functions->get_site_settings('network');
                                                                                                $wp_login_slug =   $wph->functions->get_site_module_saved_value('new_wp_login_php',  'network' );
                                                                                            }
                                                                                            else
                                                                                            $wp_login_slug =   $wph->functions->get_site_module_saved_value('new_wp_login_php',  $blog_id );
                                                                                            
                                                                            if  ( empty (  $wp_login_slug  ) )
                                                                                break;
                                                                                                                                                                               
                                                                            $replace        =   '/wp-login.php';
                                                                            $replacement    =   '/' .   $wp_login_slug;
                            ...
                            default              :
                                                                            if(is_multisite() )
                                                                                            ...
                                                                                            $admin_slug =   $wph->functions->get_site_module_saved_value('admin_url',  $blog_id );
            ...
            public function add_node( $args ) {
                ...
                if ( isset ( $args['href'] )    &&  ! empty ( $args['href'] ) )
                    $args['href']   =   $wph->functions->content_urls_replacement( $args['href'],  $wph->functions->get_replacement_list() );
                */
