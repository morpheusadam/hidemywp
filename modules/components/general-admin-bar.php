                    ...
                    foreach  ( $wp_roles     as  $role_slug  =>  $role )
                        {
                            ...
                            $this->component_settings[]                  =   $this->_prepare_modle_setting( $role_slug, $role['name'], $first );
                            $first  =   FALSE;                                        
                        }
            ...
            function remove_admin_bar()
                {
                    ...
                    $role_hide_admin_bar    =   $this->wph->functions->get_site_module_saved_value('remove_admin_bar_' . $user_role,$this->wph->functions->get_blog_id_setting_to_use() );
