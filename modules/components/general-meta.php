            ...
            function get_module_component_settings()
                {
                    ...
                    $this->component_settings[]                  =   array(
                                                                    ...
                                                                    'help'          =>  array(
                                                                                                'title'                     =>  __('Help',    'wp-hide-security-enhancer') . ' - ' . __('Remove feed_links Meta',    'wp-hide-security-enhancer'),
                                                                                                'description'               =>  __("This option disable all feed links outputed in the page HTML head.",    'wp-hide-security-enhancer') ,
                                                                                                'option_documentation_url'  =>  'https://www.wp-hide.com/documentation/general-html-meta/'
                                                                                                ),
                    ...
                    $this->component_settings[]                  =   array(
                                                                    ...
                                                                    'help'          =>  array(
                                                                                                'title'                     =>  __('Help',    'wp-hide-security-enhancer') . ' - ' . __('Remove profile link',    'wp-hide-security-enhancer'),
                    ...
                    $this->component_settings[]                  =   array(
                                                                    ...
                                                                    'help'          =>  array(
                                                                                                'title'                     =>  __('Help',    'wp-hide-security-enhancer') . ' - ' . __('Remove canonical link',    'wp-hide-security-enhancer'),
