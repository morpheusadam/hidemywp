            ...
            function _init_new_wp_comments_post($saved_field_data)
                {
                    ...
                    $url            =   $this->wph->functions->prepare_path (    site_url()  . '/' . 'wp-comments-post.php' );
                    $replacement    =   $this->wph->functions->prepare_path (    site_url()  . '/' .  $saved_field_data );
            ...
            function _callback_saved_new_wp_comments_post($saved_field_data)
                {
                    ...
                    $rewrite_to     =   $this->wph->functions->get_rewrite_path( 'wp-comments-post.php', [ 'left_slash'  =>  TRUE, 'right_slash' =>  FALSE, 'include_full_path' =>  TRUE  ] );
            ...
            function _callback_saved_block_wp_comments_post_url($saved_field_data)
                {
                    ...
                    $rewrite_base   =   $this->wph->functions->get_rewrite_path( 'wp-comments-post.php', [ 'left_slash'  =>  FALSE, 'right_slash' =>  FALSE ] );
                    ...
                    if($this->wph->server_nginx_config   === TRUE)           
                        {
                            ...
                            $rewrite_base   =   $this->wph->functions->get_rewrite_path( 'wp-comments-post.php', [ 'left_slash'  =>  TRUE, 'right_slash' =>  FALSE, 'include_full_path' =>  TRUE, 'type' =>  'nginx' ] );
