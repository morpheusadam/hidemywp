            ...
            function get_interface_menu_data()
                {
                    ...
                    $interface_data['menu_title']       =   __('<span class="wph-info">Setting&rarr;</span> CDN',    'wp-hide-security-enhancer');
            ...
            function get_interface_data()
                {
                    ...
                    $interface_data['title']              =   __('WP Hide & Security Enhancer <span class="plugin-mark">PRO</span> - CDN',    'wp-hide-security-enhancer');
