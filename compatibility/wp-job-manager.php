            ...
            function upload_dir( $data )
                {
                    ...
                    $wp_content_slug            =   trim ( $wph->default_variables['content_directory'], '\/' );
                    ...
                    if  (  ! empty ( $new_upload_path ) )
                        ...
                        {
                            $new_url                =   trailingslashit(    home_url()  )   . str_replace( '/' . $wp_content_slug , $new_content_path, $wph->default_variables['uploads_directory'] );
                        }
